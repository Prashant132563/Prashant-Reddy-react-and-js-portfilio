      ...
      <div className='max-w-7xl mx-auto'>
        <div className='flex flex-col md:flex-row items-center lg:h-[90vh] justify-between' >
            <div className='md:w-1/2 mb-8 md:mb-0 flex flex-col space-y-4 px-6 lg:px-0 lg:mt-0 mt-10'>
               <h1 className='lg:text-7xl text-4xl font-bold lg:leading-snug text-white'>Hi There, <br />I'm K.V.Prashant <span className='text-red-500'>Reddy</span></h1>
               ...
               <button className='bg-white text-black px-3 py-2 w-max rounded-md'><a href="https://drive.google.com/file/d/15_VIuPHz1kE8Z1Oo54xFbEkNJhmgBLIj/view?usp=drivesdk" download target='_blank'>Download CV</a></button>
            </div>
